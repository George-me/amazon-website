...
const PRightColumn = () => {
  return (
    <div
      className="flex-shrink-0 w-[245px] border border-b-[1px] border-[#BBBFBF] rounded-lg"
      id="right-column"
    >
      ...
      <div className="px-[18px] pt-1 mb-3.5">
        ...
        <p className="text-sm mb-3">
          Or fastest delivery{" "}
          <span className="font-bold">Tomorrow, 7 November.</span> Order within{" "}
      ...
      >
        ...
        <p className="text-sm mb-3">
          ...
          <span className="font-bold text-[#565959]">Monday, 11 November</span>
        </p>

        <p className="text-xs text-[#565959]">Dispatched from: Amazon</p>
        <p className="text-xs text-[#565959] mt-1">Sold by: Amazon Warehouse</p>
      </div>
    </div>
  );
};
